...
#ifndef SPECTRABLE_SWIFT_H
#define SPECTRABLE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="SpectraBLE",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC10SpectraBLE10SpectraBLE")
@interface SpectraBLE : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
...
@interface SpectraBLE (SWIFT_EXTENSION(SpectraBLE)) <CBPeripheralManagerDelegate>
...
@interface SpectraBLE (SWIFT_EXTENSION(SpectraBLE)) <CBPeripheralDelegate>
